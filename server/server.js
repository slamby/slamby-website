...
app.get('/api/create-lead', function (req, res) {
    var createLead = new createLead_1.CreateLead(req.query.firstName, req.query.lastName, req.query.orgName, req.query.mobileNumber, req.query.email, req.query.website);
